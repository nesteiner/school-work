// Generated from /home/steiner/school-work/play-with-compiler/src/Calculator.g4 by ANTLR 4.9.1
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(32);
						((MulDivContext)_localctx).hello = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==MUL || _la==DIV) ) {
							((MulDivContext)_localctx).hello = (Token)_errHandler.recoverInline(this);
						}
						else {
					...
					case 2:
						...
						setState(35);
						((AddSubContext)_localctx).hello = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==ADD || _la==SUB) ) {
							((AddSubContext)_localctx).hello = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
